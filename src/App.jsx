...
// Busca las peliculas al escribir en el campo input con onchange
  ...
  return (
    <>
      <div className="container mx-auto flex flex-col justify-center items-center align-tems">
          <h1 className="text-center text-5xl font-bold text-blue-500 py-9">Finder Film</h1>
          <form className="w-4/5 shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
          <div className="flex">
              <input 
          ...
          <label className='md:w-2/3 block text-gray-500 font-bold pt-3' htmlFor="sort">
            ...
            <span className="text-sm text-white">Ordenar peliculas por nombre</span>
          </label>
          </form>       
